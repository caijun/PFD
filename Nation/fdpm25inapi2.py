...
class city:
    def __init__(self):
        ...
        self.dict = collections.OrderedDict([('area', ''), ('time_point', ''), ('primary_pollutant', ''), 
                                             ('quality', ''), ('level', ''), ('aqi', ''), ('co', ''), 
                                             ('co_24h', ''), ('no2', ''), ('no2_24h', ''), ('o3', ''), 
                                             ('o3_24h', ''), ('o3_8h', ''), ('o3_8h_24h', ''), ('pm10', ''), 
    ...
    try:
        ...
        if(data):
            if len(data) == 1:
                ...
                for area in data:
                    ct = city()
                    for key in ct.dict.keys():
                        ct.dict[key] = area[key]
                    ct.area = area['area']
                    ct.time_point = area['time_point']
